...
const HeadingAndButton = ({
  ...
  return (
    <div className="flex justify-between items-center pb-4 mb-10 border-b border-[#f43a09]">
      ...
      <Link
        ...
        className="flex justify-center items-center p-2 border bg-[#f43a09] cursor-pointer text-white text-sm rounded px-3 py-2"
      >
        {ButtonIcon && (
