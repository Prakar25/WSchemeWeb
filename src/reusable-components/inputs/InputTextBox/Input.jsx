    ...
    <Fragment>
      ...
      >
        <label className="flex items-center font-medium text-left text-gray-900 pl-1 pb-1 text-xs md:text-sm lg:text-base">
          ...
          {name} {required && <span className="text-red-700 pl-1">*</span>}
        </label>
        <input
          onBlur={async (e) => {
            rest?.onBlur(e);
          ...
          {...rest}
          autoSave="off"
          className={`placeholder:text-xs lg:placeholder:text-sm text-xs md:text-sm ${classes} border focus:outline-none focus:ring-0 focus:border-secondary ${
            errors[defaultName]
              ? "border-red-700"
