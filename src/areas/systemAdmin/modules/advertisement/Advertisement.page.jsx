...
export default function AdvertisementPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast.error(err.response?.data?.message || "Save failed. Ensure the backend API is implemented.");
    }
  };
  ...
  const startEdit = (ad) => {
    ...
    setForm({
      ...
      link: ad.link || ad.url || "#",
      image_url: ad.image?.url ? displayMedia(ad.image.url) : ad.image_url || ad.image || "",
      order: ad.order ?? 0,
