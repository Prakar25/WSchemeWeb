...
export default function AdminLogin() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-4 py-8 bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50">
      <motion.div
      ...
      >
        <div className="flex justify-center mb-6">
          <span className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-blue-100 text-blue-600">
        ...
        <form onSubmit={handleSubmit(handleAdminLogin)}>
          <Input
            ...
            type="text"
            classes="mb-4 rounded-lg px-4 py-3 text-base border-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-400 w-full"
            onChangeInput={null}
            setValue={setValue}
          />
          ...
          <PasswordInput
            ...
            classes="rounded-lg px-4 py-3 text-base border-slate-200 focus:ring-2 focus:ring-blue-500 w-full"
            onChangeInput={null}
            setValue={setValue}
          />
          ...
          <button
            ...
            className="mt-6 w-full bg-blue-600 text-white font-medium rounded-lg py-3 hover:bg-blue-700 active:scale-[0.99] transition-all disabled:opacity-60 disabled:cursor-not-allowed"
          >
          ...
          <p className="text-center text-sm text-slate-500">
            ...
            <Link to="/admin-register" className="text-blue-600 hover:text-blue-700 font-medium underline underline-offset-2">
              Register as Admin
            </Link>
          </p>
